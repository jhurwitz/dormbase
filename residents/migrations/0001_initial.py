...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'residents_resident', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('dorm', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('room', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('role', self.gf('django.db.models.fields.CharField')(default='STU', max_length=3)),
            ('year', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
        ))
        db.send_create_signal(u'residents', ['Resident'])


    def backwards(self, orm):
        # Deleting model 'Resident'
        db.delete_table(u'residents_resident')
